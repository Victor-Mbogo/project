...
//import com.kiki.navigation.ROUTE_VIEW_STUDENTS
...
@Composable
fun ViewProductScreen(navController: NavController, products: List<Product>) {
...
private suspend fun fetchProduct(productId: String, onSuccess: (Product?) -> Unit) {
    val firestore = Firebase.firestore
