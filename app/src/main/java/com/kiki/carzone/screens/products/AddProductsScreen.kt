//package com.kiki.carzone.screens.products
//
...
//import com.kiki.carzone.navigation.ROUTE_VIEW_PROD
//import kotlinx.coroutines.tasks.await
////import com.kiki.navigation.ROUTE_ADD_PRODUCT
////import com.kiki.navigation.ROUTE_HOME
////import com.kiki.navigation.ROUTE_VIEW_PROD
//import java.util.*
//
//@SuppressLint("UnusedMaterialScaffoldPaddingParameter")
//@OptIn(ExperimentalMaterial3Api::class)
//@Composable
//fun AddProductsScreen(navController: NavController, onProductAdded: () -> Unit) {
...
//
//                    if (productNameError) {
//                        Text("Make of the car is required", color = Color.Red)
//                    }
//                    if (productDescriptionError) {
//                        Text("Model & Variant is required", color = Color.Red)
//                    }
//                    if (productMileageError) {
//                        Text("Mileage is required", color = Color.Red)
//                    }
//                    if (productYearError) {
//                        Text("Year is required", color = Color.Red)
//                    }
//                    if (productPriceError) {
//                        Text("Price is required", color = Color.Red)
//                    }
